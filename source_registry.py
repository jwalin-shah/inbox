...
SOURCE_REGISTRY: tuple[SourceDefinition, ...] = (
    ...
    SourceDefinition(
        ...
        "Google Drive", 3600, "/capture/health", "Drive metadata is read through the explicit-account Inbox gateway."
    ),
    SourceDefinition(
...
def list_source_definitions() -> list[dict[str, object]]:
    """Return source capability metadata without probing providers."""
